/**
 * Asset Manager for Dental Instructions CMS
...
class AssetManager {
    ...
    initializeAssetPaths(siteVersion) {
        const assetConfigs = {
            'dr_taha': {
                favicon: 'DR.TAHA/resources/instructions_logo.ico',
                qrImage: 'DR.TAHA/resources/QR.png',
                qrScript: 'DR.TAHA/QR_image_viewer.js',
                customStyles: 'DR.TAHA/index_styles.css',
                homeUrl: 'DR.TAHA/index.html',
                creditsUrl: 'DR.TAHA/credits.html',
                resources: 'DR.TAHA/resources/'
            },
            'playground': {
                favicon: 'resources/instructions_logo.ico',
                qrImage: 'playground/resources/QR.jpeg',
                qrScript: 'playground/QR_image_viewer.js',
                customStyles: 'playground/index_styles.css',
                homeUrl: 'playground/index.html',
                creditsUrl: 'playground/credits.html',
                resources: 'playground/resources/'
            },
            'root': {
                favicon: 'resources/instructions_logo.ico',
                qrImage: 'resources/QR.jpeg',
